...
**当前方案**：见 [05-surface-control-plan.md](05-surface-control-plan.md)。先做 P1/P2：移除吞掉控件的静态内嵌表面，扁平化 `AcuInfoBanner` / 说明块 / 只读摘要；不在本轮重写主题系统，不给输入控件新增边框。P3/P4 再逐页清理并收敛 token。
