...
.acu-panel__header {
  ...
  gap: var(--acu-panel-header-gap, 12px); margin-bottom: var(--acu-panel-header-margin-bottom, 12px);
  min-height: var(--acu-panel-header-min-height, 32px);
  transition: margin-bottom 0.15s ease;
}
.acu-panel__header--description-open {
  margin-bottom: var(--acu-panel-header-open-margin-bottom, 8px);
}
.acu-panel__title {
  margin: 0;
  min-width: 0;
...
.acu-panel__header-right {
  ...
  display: flex;
  align-items: center;
  gap: var(--acu-panel-actions-gap, 8px);
  flex-shrink: 0;
}
.acu-panel__actions { display: flex; align-items: center; gap: var(--acu-panel-actions-gap, 8px); flex-shrink: 0; }
.acu-panel__description-button {
  width: var(--acu-panel-description-button-size, 28px);
  height: var(--acu-panel-description-button-size, 28px);
  display: inline-flex;
  align-items: center;
...
.acu-panel__body { display: flex; flex-direction: column; gap: var(--acu-panel-body-gap, 12px); min-width: 0; flex: 1 1 auto; }
.acu-panel__description-region {
  min-width: 0;
  overflow: hidden;
}
.acu-panel__description-region-inner {
  padding-bottom: var(--acu-panel-description-padding-bottom, 12px);
  overflow: hidden;
}
</style>
